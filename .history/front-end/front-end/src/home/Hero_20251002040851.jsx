...
function Hero() {
  ...
  return (
    <div
      style={{ backgroundColor: "#ede5dd", minHeight: "auto", width: "100%", margin: 0, padding: 0 }}
    >
      <Container
        fluid
        style={{ paddingTop: "60px", paddingBottom: "60px", margin: 0 }}
      >
        <div className="row align-items-center" style={{ minHeight: "60vh", margin: 0 }}>
          {/* Left Content */}
          <div
