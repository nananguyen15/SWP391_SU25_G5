      ...
      <Container fluid className="px-3">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav className="mx-auto">
            ...
            <Nav.Link href="#series" className="mx-3">Series</Nav.Link>
            <NavDropdown title="Categories" id="navbarScrollingDropdown" className="mx-3">
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div className="position-relative d-none d-md-block">              <FormControl
                type="search"
