      ...
      <Container fluid className="px-3">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Nav className="mx-auto">
            ...
            <Nav.Link href="#series" className="mx-3 nav-link-custom">Series</Nav.Link>
            <NavDropdown title="Categories" id="navbarScrollingDropdown" className="mx-3 nav-dropdown-custom">
