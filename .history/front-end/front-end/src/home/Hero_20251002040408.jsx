...
function Hero() {
  ...
  return (
    <div style={{ backgroundColor: "#ede5dd", minHeight: "auto", width: "100%", boxSizing: "border-box" }}>
  <Container fluid className="py-5" style={{ paddingTop: "60px" }}>
                    ...
                    {bookGroup.map((book, index) => {
                      ...
                      return (
                        <div key={book.id} className="text-center">
                          ...
                          {/* Book Info */}
                          <div style={{ maxWidth: "200px", margin: "0 auto", paddingTop: "0.5rem" }}>
                            <h5
                              style={{
                                fontSize: "1.1rem",
                                fontWeight: "bold",
